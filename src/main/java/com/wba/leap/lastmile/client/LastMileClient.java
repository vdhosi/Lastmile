package com.wba.leap.lastmile.client;
...
import com.wba.leap.lastmile.beans.ErrorMessage;
import com.wba.leap.lastmile.beans.ErrorMessages;
...
public class LastMileClient {
	Logger logger = LogManager.getLogger(LastMileClient.class);
